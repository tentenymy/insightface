...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str,
                        default='/home/meiyiyang/Face/insightface/output/log')
...
def get_symbol(args, arg_params, aux_params):
    ...
    if args.loss_type == 0:  # softmax
        ...
        extra_loss = mx.symbol.Custom(data=embedding, label=gt_label, name='center_loss',
                                      op_type='centerloss', \
                                      num_class=args.num_classes, alpha=args.center_alpha,
                                      scale=args.center_scale, batchsize=args.per_batch_size)
        ...
        nembedding = mx.symbol.reshape(nembedding, (
